...
public class Juego extends JFrame implements KeyListener, ActionListener{
    ...
    public void CrearGUI(){
        ...
        panelJuego.setBounds(0,0,1000,1000);
        panelJuego.setBackground(Color.BLACK);
        panelJuego.setLayout(null); 
        panelJuego.setDoubleBuffered(true);
        c.add(panelJuego);
        panelJuego.getGraphics();

        inicio = new JButton("Inicio");
        inicio.setBounds(0,0,100,100);
    ...
    public Juego(){
        ...
        //timer que repinta el panel
        /*notas.addElement(new Nota(0,255));
        notas.addElement(new Nota(10,380));
        notas.addElement(new Nota(20,505));
        ntas.addElement(new Nota(30,630));*/
